...
public class WebSqlDatabaseInitializerProto extends CordovaActivity implements DatabaseInitializable {
    ...
    public DatabaseConfig getDatabaseConfig() {
        ...
        // DatabaseConfig databaseConfig = new DatabaseConfig("myDemoSQLiteDB.zip", "myDemoSQLiteDB.db", "My title in my language", "My content in my language");
        // databaseConfig.setForceReload(true);
        // databaseConfig.setDatabaseDBName("Databases.db");
